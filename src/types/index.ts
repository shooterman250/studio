...
export const overallStyleOptions: OverallStyleOption[] = [
  ...
  { id: 'contemporary', name: 'Contemporary', imageUrl: `/Images/Overall_Style_Contemporary.png`, description: 'Current, fluid, and ever-evolving.', dataAiHint: 'contemporary interior' },
