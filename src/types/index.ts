...
export const overallStyleOptions: OverallStyleOption[] = [
  ...
  { id: 'overall-style-upload', name: 'Upload your own Style', imageUrl: 'https://placehold.co/400x300.png', description: 'Upload an image of your desired style.', dataAiHint: 'custom style upload'},
...
export const keyElementOptions: KeyElementOption[] = [
  ...
  { id: 'key-element-upload', name: 'Upload your own Element', imageUrl: 'https://placehold.co/400x300.png', description: 'Upload an image of your key element.', dataAiHint: 'custom element upload'},
].sort((a, b) => a.name.localeCompare(b.name));
...
export const generalWallFinishOptions: GeneralWallFinishOption[] = [
    ...
    { id: 'wall-paint', name: 'Paint', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1376591522257965076/Paint.png?ex=683733c2&is=6835e242&hm=e899725af54c91160daa83ad1bdd515e51a3d378425d69f74b3cfce0d3243c3a&=&format=webp&quality=lossless&width=1172&height=1172', dataAiHint: 'painted wall room' },
    { id: 'wall-textured', name: 'Textured (e.g., Venetian Plaster)', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1375974375622316103/Textured.png?ex=6833a37f&is=683251ff&hm=e35e11e6f51ee088ef98cc2a1b16a8c5b8900d961adfa73d8da1cd48b3be2859&=&format=webp&quality=lossless&width=1206&height=1206', dataAiHint: 'textured wall finish' },
    { id: 'wall-wallpaper', name: 'Wallpaper', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1375980031582535770/Wallpaper.png?ex=6833a8c4&is=68325744&hm=fb0abf9c9ed4577b5edb35bb59c11823f7f47d72cc3ecaa65399b5455c087ed7&=&format=webp&quality=lossless&width=1206&height=1206', dataAiHint: 'wallpaper wall room' },
    { id: 'wall-paneling', name: 'Wood Paneling / Shiplap', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1375965417922625586/Wood_Paneling.png?ex=68339b27&is=683249a7&hm=89450f495280d96697f68ecadb3d8ea8aeb8880d42679485fecb8ac58b82d337&=&format=webp&quality=lossless&width=998&height=998', dataAiHint: 'wood paneling wall' },
].sort((a, b) => a.name.localeCompare(b.name));
