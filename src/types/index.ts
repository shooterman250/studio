...
export const overallStyleOptions: OverallStyleOption[] = [
  ...
  { id: 'contemporary', name: 'Contemporary', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575694533931058/Overall_Style_Contemporary.png?ex=681fff95&is=681eae15&hm=8a113b38315903c0e90f2a2a619777d43d5da32a3379b30e434b54a414339354&=&format=webp&quality=lossless&width=700&height=700`, description: 'Current, fluid, and ever-evolving.', dataAiHint: 'contemporary interior' },
  { id: 'traditional', name: 'Traditional', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575696505524335/Overall_Style_Traditional.png?ex=681fff96&is=681eae16&hm=8a22699bf0cc8d42c76b0f9204128f650d59a47f25c00d76c46ba2e0d107e95a&=&format=webp&quality=lossless&width=700&height=700`, description: 'Classic, timeless, and ornate.', dataAiHint: 'traditional interior' },
  { id: 'industrial', name: 'Industrial', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575696060981328/Overall_Style_Industrial.png?ex=681fff96&is=681eae16&hm=df060a6b367217a212a6f33b9e0e4dfb485d261f7167c394bc4a3433c850d0c6&=&format=webp&quality=lossless&width=700&height=700`, description: 'Raw, edgy, with exposed elements.', dataAiHint: 'industrial interior' },
  { id: 'country-farmhouse', name: 'Country/Farmhouse', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575695009718343/Overall_Style_Country_Farmhouse.png?ex=681fff95&is=681eae15&hm=18309f4a4bbba403c6dfb313ac94614656131870f348a731424e86c631768964&=&format=webp&quality=lossless&width=700&height=700`, description: 'Warm, rustic, and inviting.', dataAiHint: 'farmhouse interior' },
  { id: 'coastal', name: 'Coastal', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575694122930186/Overall_Style_Coastal.png?ex=681fff95&is=681eae15&hm=57476353f411df9d53756075048985e31ac1f9d5114967e78e0c66703e5a90d4&=&format=webp&quality=lossless&width=700&height=700`, description: 'Light, airy, and beach-inspired.', dataAiHint: 'coastal interior' },
  { id: 'mid-century', name: 'Mid-Century Modern', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575695701925928/Overall_Style_Mid_Century.png?ex=681fff95&is=681eae15&hm=b41473f9f74ff40b3fe4a223d377004e56589e47b0203308030a3c35b1964256&=&format=webp&quality=lossless&width=700&height=700`, description: 'Retro, organic shapes, and functionality.', dataAiHint: 'midcentury modern interior' },
  { id: 'japandi', name: 'Japandi', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575695701925928/Overall_Style_Mid_Century.png?ex=681fff95&is=681eae15&hm=b41473f9f74ff40b3fe4a223d377004e56589e47b0203308030a3c35b1964256`, description: 'Japanese minimalism meets Scandinavian function.', dataAiHint: 'japandi interior' },
  { id: 'bohemian', name: 'Bohemian', imageUrl: `https://media.discordapp.net/attachments/1370568040256901200/1370575693560926208/Overall_Style_Bohemian.png?ex=681fff95&is=681eae15&hm=c62fe503f338020ba0998d11531057d9159682288c5d53d7346a04320a2ac3d6&=&format=webp&quality=lossless&width=700&height=700`, description: 'Eclectic, colorful, and free-spirited.', dataAiHint: 'bohemian interior' },
