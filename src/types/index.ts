...
export const kitchenHardwareFinishOptions: KitchenHardwareFinishOption[] = [
    ...
    { id: 'k-hardware-crystal', name: 'Crystal or Glass', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1375208011290644511/Crystal_or_Glass_Hardware.png?ex=6830d9c4&is=682f8844&hm=98a3ffbf2695d60af6547d34e0c0072fd1b7062a0495077402b0601a9e462576&=&format=webp&quality=lossless&width=996&height=996', dataAiHint: 'crystal kitchen hardware' },
    ...
    { id: 'k-hardware-multitone', name: 'Multi-Tone/Abstract', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1375203520168464495/Two-Toned_or_Abstract_.png?ex=6830d595&is=682f8415&hm=7baf63f581d3b51f43205bd775c7a18e4fe2e5ebe82b60abb2e0d043dd0615bc&=&format=webp&quality=lossless&width=996&height=996', dataAiHint: 'abstract hardware' },
].sort((a, b) => a.name.localeCompare(b.name));
...
export const bathroomHardwareFinishOptions: BathroomHardwareFinishOption[] = [
  ...
  { id: 'bath-hardware-crystal', name: 'Crystal or Glass', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1375208011290644511/Crystal_or_Glass_Hardware.png?ex=6830d9c4&is=682f8844&hm=98a3ffbf2695d60af6547d34e0c0072fd1b7062a0495077402b0601a9e462576&=&format=webp&quality=lossless&width=996&height=996', dataAiHint: 'crystal bathroom hardware' },
  ...
  { id: 'bath-hardware-multitone', name: 'Multi-Tone/Abstract', imageUrl: 'https://media.discordapp.net/attachments/1374799696127721638/1375203520168464495/Two-Toned_or_Abstract_.png?ex=6830d595&is=682f8415&hm=7baf63f581d3b51f43205bd775c7a18e4fe2e5ebe82b60abb2e0d043dd0615bc&=&format=webp&quality=lossless&width=996&height=996', dataAiHint: 'abstract hardware' },
].sort((a, b) => a.name.localeCompare(b.name));
...
].filter(option => option.id !== 'bath-store-customvanity' && option.id !== 'bath-store-niches').sort((a,b) => a.name.localeCompare(b.name)); // Removed Custom Vanity globally
